...
if [ ! -e ${INITIALIZATION_FILE} ]; then
  ...
  echo y | android update sdk --no-ui --filter android-17 --all > /dev/null
  ...
  echo y | android update sdk --no-ui --filter addon-google_apis-google-17 --all > /dev/null
  ...
  echo y | android update sdk --no-ui --filter sys-img-armeabi-v7a-android-17 --all > /dev/null
